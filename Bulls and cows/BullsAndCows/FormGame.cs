...
namespace BullsAndCows
{
    public class FormGame : Form
    {
        ...
        public FormGame(int i_NumberOfChances)
        {
            ...
            this.m_FormPickAColor = new FormPickAColor();
        ...
        private void buttonArrow_Click(object sender, EventArgs e)
        {
            ...
            if (m_Game.GameStatus == Utils.eGameStatus.Success)
            {
                endGame(Properties.Resources.winner);
            }
            else if(m_CurrentNumberOfTurn == m_NumberOfChances - 1)
            {
                endGame(Properties.Resources.loser);
            }
            else
            {
        ...
        private void endGame(Image i_imageStatusGame)
        {
            showComputerSequence();
            PictureBox pictureBox = new PictureBox();
            pictureBox.Image = i_imageStatusGame;
